...
$getIdEdit     = $_GET['ID_MENU'];

$getData       = mysqli_query($connect, "SELECT * FROM tabel_menu WHERE ID_MENU=$getIdEdit");
while($show    = mysqli_fetch_array($getData)){
    $namaMenu  = $show['NAMA_MENU'];
    $hargaMenu = $show['HARGA'];
}
...
if(isset($_POST['editMenu'])){
    ...
    $queryUpdate = mysqli_query($connect,"UPDATE tabel_menu SET NAMA_MENU='$namaMenu', JENIS='$jenisMenu', HARGA=$hargaMenu WHERE ID_MENU=$getIdEdit");
    if($queryUpdate){
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: rgb(36,77,123);height: 70px;">
                            <h6 class="text-white font-weight-bold m-0">Edit Menu</h6>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <form class="user" method="POST">
                                            <strong>Nama</strong>
                                            <input class="form-control form-control-user" type="text" id="namaMenu" aria-describedby="emailHelp" value="<?php echo $namaMenu;?>" name="namaMenu" style="border-radius: 2em;max-width: 400px;margin-top: 5px;margin-bottom: 20px;">
                                            <strong>Jenis</strong>
                                                ...
                                                <strong>Harga</strong>
                                                <input class="form-control form-control-user" type="text" id="exampleInputEmail-1" aria-describedby="emailHelp" value="<?php echo $hargaMenu;?>" name="hargaMenu" style="border-radius: 2em;max-width: 400px;margin-top: 5px;">
                                                    <div class="form-row">
                                                        <div class="col text-right" style="margin-top: 10px;">
                                                        <button name="editMenu" class="btn btn-primary" type="submit" style="border-radius: 1em;background-color: #ebac77;border-color: #ebac77;">
                                                        <i class="fa fa-save" style="margin-right: 9px;"></i>Simpan</button>
                                                    </div>
                                    </div>
                                    </form>
                                </div>
