                                        ...
                                        <div class="form-row text-right" style="margin-top: 20px;">
                                            <div class="col" style="max-width: 530px;">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <input class="form-control form-control-user" type="number" id="bayarTunai" placeholder="<?php echo $bayarTunai; ?>" name="bayarTunai" style="padding: 1px;border-radius: 0 0 10px 0;"></div>
                                                </div>
                                                <div class="form-row" style="margin-top: 5px;">
                                                    <div class="col" style="padding-top: 5px;">
                                                        <h1 class="text-right" style="font-size: 16px;">Kembalian :</h1>
                                                    </div>
                                                    <div class="col"><input class="form-control form-control-user" type="number" id="kembelian" placeholder="<?php echo $kembalian; ?>" name="kembalian" style="padding: 1px;border-radius: 0 0 10px 0;"></div>
                                                </div>
                                                <div class="form-row" style="margin-top: 5px;">
                                                    <div class="col" style="padding-top: 5px;">
